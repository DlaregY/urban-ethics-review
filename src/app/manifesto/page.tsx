  ...
  return (
    <article className="mx-auto max-w-2xl px-4 pb-16">
      ...
      <div className="prose-urban font-body text-ink/90">
        ...
        <p>We need to address the garments, because the harm extends across every product line. City Core trades heavily in what we call &ldquo;infrastructural chic&rdquo;: clothing and hats that romanticize the textures of urban decay—cracked pavement prints, manhole cover motifs, a tank top described as &ldquo;rust-adjacent,&rdquo; a necklace shaped like a fire escape—while saying nothing about the municipal austerity budgets that produced the decay in the first place. You do not wear a pothole. You fill it, or you advocate for its filling. City Core has instead chosen a third path: you monetize it. This is appropriation operating at full, terrifying efficiency. The culture has been swallowed whole, put on a bracelet, and is being sold back to us for $120.</p>
